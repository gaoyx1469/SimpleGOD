 ...
 * 2、新建一个用户
 * 3、新建一个APP同时级联新建一个用户
 * 4、新建一个APP，增加一个已存在的用户与其的关系
 * 5、新建一个用户，增加其与一个已经存在的APP的关系
 * 6、建立一个已存在的APP与一个已存在的用户的关系
 * 7、建立一个已存在的APP与多个已存在的用户的关系
 * 8、建立多个已存在的APP与多个已存在的用户的关系
 * 9、移除一个已存在的APP与一个已存在的用户的关系
 * 10、移除一个已存在的APP与多个已存在的用户的关系
 * 11、修改一个已存在的APP与一个已存在的用户的关系，变更为该用户与另一已存在的APP的关系
 * 12、删除APP
 * 13、删除用户
 * 
 * @author Gaoyx
